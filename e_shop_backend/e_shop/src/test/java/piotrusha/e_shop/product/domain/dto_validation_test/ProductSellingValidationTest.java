...
import static piotrusha.e_shop.product.domain.dto_validation_test.SampleDtosToValidate.sellProductDtoWithNegativePiecesNumber;
import static piotrusha.e_shop.product.domain.dto_validation_test.SampleDtosToValidate.sellProductDtoWithProductId;
import static piotrusha.e_shop.product.domain.dto_validation_test.SampleDtosToValidate.sellProductDtoWithZeroPiecesNumber;
import static piotrusha.e_shop.product.domain.dto_validation_test.SampleDtosToValidate.sellProductDtoWithoutPiecesNumber;
import static piotrusha.e_shop.product.domain.dto_validation_test.SampleDtosToValidate.sellProductDtoWithoutProductId;
